      ...
      <div className="flex-none gap-4 items-center">
          ...
          <div className="text-sm font-medium mr-2 flex flex-col">
            {timeLeftMinutes !== null ? (
              <span
                className={
                  timeLeftMinutes > 0
                    ? "text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-200"
                    : "text-red-500 bg-red-50 px-3 py-1 rounded-full border border-red-200"
                }
              >
        ...
        {currentUser ? (
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow border"
            >
              <li>
                <Link
                  to={
                    currentUser.role === "admin" ? "/admin/profile" : "/profile"
                  }
                >
                  Profile
                </Link>
          ...
          <div className="flex gap-2">
            ...
            <Link className="btn bg-black text-white btn-sm" to="/register">
              Register
            </Link>
          </div>
        )}
